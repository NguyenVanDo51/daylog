export const en = {
  ...
  settings: { title: 'Settings', push_label: 'Push notifications',
    reminders_label: 'Capture reminders', reminders_hint: '7 nudges per day, 9am–9pm', signout: 'Sign out', feedback: 'Send feedback',
